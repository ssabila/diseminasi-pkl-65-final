...
import imgPattern7 from "../../../assets/images/pattern_7.png";
import imgPattern4 from "../../../assets/images/pattern_4_orange_grid.png";
...
const briefingPhotos = [briefingPhoto1, briefingPhoto2, briefingPhoto3, briefingPhoto4];
...
export const View4 = () => {
  ...
  useGSAP(
    () => {
      ...
      // Pin pop-up stagger
      gsap.fromTo(".v4-loc-pin", { scale: 0, opacity: 0 }, { scale: 1, opacity: 1, duration: 0.4, ease: "back.out(1.7)", stagger: 0.1, scrollTrigger: { trigger: mapRef.current, start: "top 75%", toggleActions: "play none none reverse" } });
    ...
    <section className="ws1-nadia-view4" ref={sectionRef}>
      ...
      <div className="v4-hero" ref={heroRef}>
        <div className="v4-hero-bg">
          <img src={imgHero} alt="Briefing Keberangkatan" />
        </div>
        ...
        <div className="v4-hero-content">
          ...
          <p className="v4-hero-desc">510 mahasiswa STIS diterjunkan ke Aceh, Sumatera Utara, dan Sumatera Barat.</p>
        </div>
      </div>

      {/* ── Section B: Peta Sumatera & Alokasi (Interactive Dashboard) ── */}
      <div className="v4-map-section" ref={mapRef}>
        <div className="v4-map-pattern-divider top" style={{ backgroundImage: `url(${imgPattern7})` }} />
        <div className="v4-map-pattern-divider bottom" style={{ backgroundImage: `url(${imgPattern7})` }} />
        ...
        <div className="v4-map-layout-standout">
          ...
          <div className="v4-map-dashboard v4-hud-panel">
            <div className="v4-hud-corner tl" />
            <div className="v4-hud-corner tr" />
            <div className="v4-hud-corner bl" />
            <div className="v4-hud-corner br" />

            <div className="v4-dashboard-inner">
              {activeProvince !== null && <span className="v4-db-kicker">PROVINSI TERPILIH</span>}
              <h4 className="v4-db-title">{activeProvince !== null ? PROVINCES[activeProvince].name : "R3P Sumatra 2026"}</h4>

              <div className="v4-db-stats-grid">
                <div className="v4-db-stat-box">
                  <span className="v4-db-stat-num" key={`mhs-${activeProvince}`}>
                    {activeProvince !== null ? PROVINCES[activeProvince].mhs : "510"}
                  </span>
                  <span className="v4-db-stat-label">Mahasiswa</span>
                </div>
                <div className="v4-db-stat-box">
                  <span className="v4-db-stat-num" key={`pml-${activeProvince}`}>
      ...
      <div className="v4-briefing-section" ref={briefingRef}>
        <div className="v4-briefing-header">
          <h3 className="v4-briefing-title">
            Briefing <em>Terakhir</em>
          </h3>
        </div>
            ...
            <div key={i} className="v4-brief-stack-card">
              ...
              <div className="v4-bsc-right">
                <div className="v4-bsc-header-row">
                  <span className="v4-bsc-pill">
                    {card.region} - {card.pclCount}
                  </span>
        ...
        {/* Placed at the end to avoid shifting DOM indices and breaking manual event listeners */}
        <img src={imgPattern4} className="v4-spinning-pattern left" alt="Decorative Pattern" />
        <img src={imgPattern4} className="v4-spinning-pattern right" alt="Decorative Pattern" />
      </div>
    </section>
  );
};
  ...
  return (
    <section className="ws1-nadia-view9" ref={closingRef}>
      ...
      <div className="v9-content">
        ...
        <p className="v9-closing-text">510 mahasiswa. 3 provinsi. 15 kabupaten/kota.</p>

        <div className="v9-stats-row">
          <div className="v9-stat">
            <span className="v9-stat-num" data-target="510">
              0
            </span>
            <span className="v9-stat-label">Mahasiswa</span>
          </div>
          <div className="v9-stat">
            <span className="v9-stat-num" data-target="3">
              0
            </span>
            <span className="v9-stat-label">Provinsi</span>
          </div>
          <div className="v9-stat">
            <span className="v9-stat-num" data-target="15">
              0
            </span>
            <span className="v9-stat-label">Kabupaten/Kota</span>
          </div>
          <div className="v9-stat">
            <span className="v9-stat-num" data-target="52">
              0
            </span>
        ...
        <p className="v9-credits">PKL Angkatan 65 · Politeknik Statistika STIS · 2026</p>
      </div>
    </section>
  );
};
